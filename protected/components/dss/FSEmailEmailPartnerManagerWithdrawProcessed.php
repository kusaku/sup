...
class FSEmailEmailPartnerManagerWithdrawProcessed extends FSEmail {
	protected $sType='emailPartnerManagerWithdrawProcessed';
	protected $obUser;
	...
	protected function getController() {
		$arResult=Yii::app()->createController('documents/email/partnermanagerwithdrawprocessed');
	...
	public function _getAsHtml() {
		if($obController=$this->getController()) {
			$obController->createAction('partnermanagerwithdrawprocessed')->runWithParams(array('withdraw'=>$this->obWithdraw,'user'=>$this->obUser));
