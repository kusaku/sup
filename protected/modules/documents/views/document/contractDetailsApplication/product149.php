...
<p style="text-align:right;"><font face="Arial, sans-serif" size="2"><b>Приложение №1 от <?php echo LangUtils::dateFormated(time())?><br/>
	к Договору №<?php echo $package->getNumber()?> от <?php echo LangUtils::dateFormated(time())?></b></font></p>
<p><br/></p>
...
<?php $this->renderPartial('contractDetailsApplication/servicesList',array('product'=>$product,'services'=>$services,'package'=>$package));?>
...
<ul style="list-style: circle;padding-left:40px;">
	...
	<li><font face="Arial, sans-serif" size="2">Хостинг (6 месяцев)</font></li>
	<li><font face="Arial, sans-serif" size="2">Готовый дизайн сайта (макет)</font></li>
	<li><font face="Arial, sans-serif" size="2">Функция создания неограниченного количества страниц</font></li>
	...
	<li><font face="Arial, sans-serif" size="2">Каталог товаров (до 500 товаров)</font></li>
	<li><font face="Arial, sans-serif" size="2">Удобное перемещение товаров</font></li>
	<li><font face="Arial, sans-serif" size="2">Уведомление о смене статуса заказа</font></li>
	<li><font face="Arial, sans-serif" size="2">Система оплаты: банковские карты, терминалы, электронная валюта</font></li>
	<li><font face="Arial, sans-serif" size="2">Функция расширенного поиска</font></li>
	<li><font face="Arial, sans-serif" size="2">Несколько фотографий товаров</font></li>
	<li><font face="Arial, sans-serif" size="2">Интеграция с сервисом Яндекс.Маркет</font></li>
	...
	<li><font face="Arial, sans-serif" size="2">Социальные кнопки</font></li>
	<li><font face="Arial, sans-serif" size="2">Подписка на новости</font></li>
	<li><font face="Arial, sans-serif" size="2">Спецпредложения</font></li>
	<li><font face="Arial, sans-serif" size="2">Сортировка каталога</font></li>
	<li><font face="Arial, sans-serif" size="2">Фильтрация товаров в каталоге</font></li>
	<li><font face="Arial, sans-serif" size="2">Выбор способа доставки</font></li>
	<li><font face="Arial, sans-serif" size="2">Несколько цен у товара</font></li>
</ul>
