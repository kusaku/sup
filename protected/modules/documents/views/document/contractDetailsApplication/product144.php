...
<ul style="list-style: circle;padding-left:40px;">
	...
	<li><font face="Arial, sans-serif" size="2">Страница организация мастер-классов</font></li>
	<li><font face="Arial, sans-serif" size="2">Страница организации Веб-семинаров</font></li>
	<li><font face="Arial, sans-serif" size="2">Веб-консультации для обучающихся (модуль «Вопросы-ответы»)</font></li>
	<li><font face="Arial, sans-serif" size="2">Веб-консультации для родителей (модуль «Вопросы-ответы»)</font></li>
	<li><font face="Arial, sans-serif" size="2">Модуль “Новости”</font></li>
	<li><font face="Arial, sans-serif" size="2">Модуль “Календарь событий”</font></li>
	<li><font face="Arial, sans-serif" size="2">Модуль “Социальные кнопки”</font></li>
</ul>
...
<p style="text-align: justify;font-family: Arial, sans-serif;font-size:13px;"><font face="Arial, sans-serif" size="2">
	...
	ЭВМ "MODX Revolution", v.2.2.4, 2012 года выпуска, представляющую собой систему управления Сайтом, на условиях лицензии «GNU General Public License, Version 2, June 1991»,
