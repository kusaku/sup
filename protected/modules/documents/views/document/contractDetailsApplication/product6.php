...
<ul style="list-style: circle;padding-left:40px;">
	...
	<li><font face="Arial, sans-serif" size="2">20 страниц сайта-магазина</font></li>  
	...
	<li><font face="Arial, sans-serif" size="2">Полный комплект средств для управления и автоматизация заказов</font></li>  
	<li><font face="Arial, sans-serif" size="2">Система оплаты Интернет-деньгами Robokassa</font></li>  
	<li><font face="Arial, sans-serif" size="2">Функция поиска по каталогу</font></li>  
	<li><font face="Arial, sans-serif" size="2">Форма регистрации клиентов</font></li>  
	<li><font face="Arial, sans-serif" size="2">Форма рассылки по базе клиентов</font></li>  
	<li><font face="Arial, sans-serif" size="2">Функция экспорта товаров в Яндекс.Маркет</font></li>  
