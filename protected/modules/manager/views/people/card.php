	...
	<div class="addClientWindow" id="sm_content">
		...
		<div class="clientInfo">
			...
			<div class="column wide">
				...
				<p class="label">Юр. лицо:</p>
				<p><a href="<?php echo Yii::app()->createUrl('manager/people/jur_reference',array('id'=>$client->jur_person->id))?>" target="_blank"><?php echo $client->jur_person->title?></a></p>
				<?php endif?>
			</div>
		</div>
		<div class="orders">
			...
			<div class="scroll-pane">
				...
				foreach ($sites as $site) {
					...
					foreach ($packages as $package) {
						...
						if ($package->summ)
							print '&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.$package->summ.'руб.</strong>';
						print '</a>';
						...
						foreach ($uslugi as $usluga) {
							...
							print '</div>';
							$summ = $summ + $usluga->price * $usluga->quant;
