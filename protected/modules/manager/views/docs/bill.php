...
<table rules="NONE" cols="6" cellspacing="0" border="0" width="100%">
	...
	<tbody>
		<?php if($package->jur_person):?>
			<tr>
				<td colspan="5" width="597"><b>ПОСТАВЩИК:  <?php echo $package->jur_person->title?></b></td>
				<td valign="top" rowspan="3"><img src="/images/fabricalogo.jpg" style="float: right; margin: 5px 5px 0 5px;"></td>
			</tr>
			<tr><td colspan="5"><b>ИНН <?php echo $package->jur_person->inn?></b></td></tr>
			<tr><td colspan="5"><b>КПП <?php echo $package->jur_person->kpp?></b></td></tr>
			<tr><td colspan="6" style="font-weight:bold;">Адрес: <?php echo $package->jur_person->address?></td></tr>
			<tr><td colspan="6"><b>Р/с <?php echo $package->jur_person->settlement_account?></b></td></tr>
			<tr><td colspan="6"><b><?php echo $package->jur_person->bank_title?></b></td></tr>
			<tr><td colspan="6"><b>к/с <?php echo $package->jur_person->correspondent_account?></b></td></tr>
			<tr><td colspan="6"><b>БИК <?php echo $package->jur_person->bank_bik?></b></td></tr>
		<?php else:?>
			<tr>
				<td colspan="5" width="597"><b>ПОСТАВЩИК:  ООО «Фабрика сайтов»</b></td>
				<td valign="top" rowspan="5"><img src="/images/fabricalogo.jpg" style="float: right; margin: 5px 5px 0 5px;"></td>
			</tr>
			<tr><td colspan="5"><b>ИНН 7813367872</b></td></tr>
			<tr><td colspan="5"><b>КПП 781301001</b></td></tr>
			<tr><td colspan="6"><b>Адрес: 194044, г. Санкт-Петербург, ул. Смолячкова, д. 4/2</b></td></tr>
			<tr><td colspan="6"><b>Р/с 40702810232130000000</b></td></tr>
			<tr><td colspan="6"><b>В Дополнительном офисе «Светлановский» Филиала «Санкт-Петербургский» ОАО «АЛЬФА-БАНК»</b></td></tr>
			<tr><td colspan="6"><b>к/с 30101810600000000786</b></td></tr>
			<tr><td colspan="6"><b>БИК 044030786</b></td></tr>
		<?php endif?>
		<tr>
		...
		<tr>
			<td align="left" valign=bottom colspan="6" style="height: 68px; background:url(/images/signature-small.png) 260px 10px no-repeat;">
				<?php if($package->jur_person):?>
		...
		<?php /*<tr>
			<td align="left" colspan="6" valign=bottom style="height: 68px; background:url(/images/signature-small.png) 180px 10px no-repeat;">
