...
?>
<!--mpdf<htmlpagefooter name="contractFooter">
	<table width="100%" border="0">
		<tr>
			<td width="33%">&nbsp;</td>
			<td width="33%" align="center"><font face="Arial, sans-serif" size="2" color="#000000">{PAGENO}</font></td>
			<td width="33%" align="right" style="font-size:10px;font-family:Arial, sans-serif;">
				Тел./факс: (495) 646-01-96<br/>
				(812) 643-43-11<br/>
				Регионы России: 8 (800) 333-88-30<br/>
				info@fabricasaitov.ru<br/>
				фабрика-сайтов.рф<br/>
			</td>
        </tr>
	</table>
</htmlpagefooter>mpdf-->
<!--mpdf<htmlpageheader name="contractHeader">
	<p align="RIGHT"><img src="/images/fabricalogo.jpg" align="right" /></p>	
</htmlpageheader>mpdf-->
...
<p align="JUSTIFY">
	<font face="Arial, sans-serif" size="2" color="#000000">
		<?php if($package->jur_person):?>
			<?php /* Установлено юридическое лицо для пакета*/?> 
			<b><?php echo $package->jur_person->title?></b>, именуемое в дальнейшем «Исполнитель», уполномоченным лицом которого является 
			<?php echo $package->jur_person->director_position?> <?php echo $package->jur_person->director_fio?>, действующий на основании
			<?php switch($package->jur_person->director_source) {
					case 'charter':
						echo "Устава";
					break;
					case 'warrant':
						echo "Доверенности ".$package->jur_person->director_source_info;
					break;
					case 'order':
						echo "Приказа ".$package->jur_person->director_source_info;
					break;
					case 'protocol':
						echo "Протокола ".$package->jur_person->director_source_info;
					break;
				}?>
		<?php else:?>
			<?php /* По умолчанию*/?>
			 ООО «ФС груп» в лице генерального директора Захарьева Д.Л., действующего на основании Устава (именуемое в дальнейшем «Исполнитель»)
		<?php endif?>
		и 
		<?php if($client->jur_person):?>
			<b><?php echo trim($client->jur_person->title)?></b>,  именуемое в дальнейшем «Заказчик»,  уполномоченным лицом которого является
			<?php echo $client->jur_person->director_fio?>, действующий на основании <?php
			switch($client->jur_person->director_source) {
				case 'charter':
					echo "Устава";
				break;
				case 'warrant':
					echo "Доверенности ".$client->jur_person->director_source_info;
				break;
				case 'order':
					echo "Приказа ".$client->jur_person->director_source_info;
				break;
				case 'protocol':
					echo "Протокола ".$client->jur_person->director_source_info;
				break;
			}?>,
		<?php else:?>
			<?php echo $client->firm?>, именуемое в дальнейшем «Заказчик»,  уполномоченным лицом которого является
			<?php if(!isset($client->attr['person']) || $client->attr['person']=='')
					if($client->jur_person->director_fio!='')
						$fio=$client->jur_person->director_fio;
					else
						$fio=$client->fio;
				else
					$fio=$client->attr['person']->values[0]->value;
				echo $fio;
			?>, действующий на основании устава,
		<?php endif?> а вместе именуемые «Стороны», заключили настоящий Договор о нижеследующем.
	</font>
</p>
<p><br></p>
...
<table width="100%" cellpadding="5" cellspacing="0">
	...
	<tbody>
		...
		<tr valign="TOP">
			<?php if($package->jur_person):?>
				<td style="border: none; padding: 0cm 0.5cm 0cm 0cm;" height="152" valign="top">
					<p><font face="Arial, sans-serif" size="2"><?php echo $package->jur_person->title?></font></p>
					<p><font face="Arial, sans-serif" size="2">ИНН <?php echo $package->jur_person->inn?></font></p>
					<p><font face="Arial, sans-serif" size="2">КПП <?php echo $package->jur_person->kpp?></font></p>
					<p><font face="Arial, sans-serif" size="2">Адрес: <?php echo $package->jur_person->address?></font></p>
					<p><font face="Arial, sans-serif" size="2">Р/с <?php echo $package->jur_person->settlement_account?></font></p>
					<p><font face="Arial, sans-serif" size="2"><?php echo $package->jur_person->bank_title?></font></p>
					<p><font face="Arial, sans-serif" size="2">к/с <?php echo $package->jur_person->correspondent_account?></font></p>
					<p><font face="Arial, sans-serif" size="2">БИК <?php echo $package->jur_person->bank_bik?></font></p>
				</td>
			<?php else:?>
				<td style="border: none; padding: 0cm 0.5cm 0cm 0cm;" height="152" valign="top">
					<p class="western"><font face="Arial, sans-serif" size="2">ООО «ФС груп»</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">ИНН 7813527798</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">КПП 781301001</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">Адрес: 194044, г. Санкт-Петербург, ул. Смолячкова, д. 4/2</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">ОГРН 1127847110544</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">Р/с 40702810990650000023</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">В ДО "Петровский" ОАО "Банк Санкт-Петербург"</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">К/с 30101810900000000790</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">БИК 044030790</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">ОКПО 38101956</font></p>
				</td>
			<?php endif?>
			<?php if($client->jur_person):?>
				<td style="border: none; padding: 0cm;" height="152" valign="top">
					<p class="western"><font face="Arial, sans-serif" size="2"><?php echo $client->jur_person->title?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">ИНН <?php echo $client->jur_person->inn?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">КПП <?php echo $client->jur_person->kpp?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">Адрес: <?php echo $client->jur_person->address?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">Р/с <?php echo $client->jur_person->settlement_account?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2"><?php echo $client->jur_person->bank_title?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">к/с <?php echo $client->jur_person->correspondent_account?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">БИК <?php echo $client->jur_person->bank_bik?></font></p>
				</td>
			<?else:?>
				<td style="border: none; padding: 0cm" valign="top">
					<p class="western"><font face="Arial, sans-serif" size="2"><?= ! empty($client->attr['name']) ? $client->attr['name']->values[0]->value : $client->firm; ?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">ИНН <?= ! empty($client->attr['vatnum']) ? $client->attr['vatnum']->values[0]->value : ''; ?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">КПП <?= ! empty($client->attr['kpp']) ? $client->attr['kpp']->values[0]->value : ''; ?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">
						<?= ! empty($client->attr['la_state']) ? $client->attr['la_state']->values[0]->value : ''; ?>
						<?= ! empty($client->attr['la_postcode']) ? $client->attr['la_postcode']->values[0]->value : ''; ?>,
						<?= ! empty($client->attr['la_city']) ? $client->attr['la_city']->values[0]->value : ''; ?>,
						<?= ! empty($client->attr['la_address']) ? $client->attr['la_address']->values[0]->value : ''; ?>,
					</font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">Р/c <?= ! empty($client->attr['rs']) ? $client->attr['rs']->values[0]->value : ''; ?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2"><?= ! empty($client->attr['bankname']) ? $client->attr['bankname']->values[0]->value : ''; ?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">К/с <?= ! empty($client->attr['ks']) ? $client->attr['ks']->values[0]->value : ''; ?></font></p>
					<p class="western"><font face="Arial, sans-serif" size="2">БИК <?= ! empty($client->attr['bik']) ? $client->attr['bik']->values[0]->value : ''; ?></font></p>
				</td>
			<?php endif?>
		</tr>
	</tbody>
...
if($obProduct=$package->getProduct()) {
	if($this->getViewFile('contract_application/product'.$obProduct->id)) {
		echo $this->renderPartial('contract_application/product'.$obProduct->id,array('package'=>$package,'product'=>$obProduct,'client'=>$client,'nostamps'=>1),true);
	}
}
