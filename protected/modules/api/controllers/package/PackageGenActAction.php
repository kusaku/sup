<?php
/**
 * Класс выполняет обработку функции packageGenAct
 */
class PackageGenActAction extends ApiUserAction implements IApiGetAction {
	function run() {
		...
		try {
			$sContent=Yii::app()->getComponent('documents')->createAct($obPackage)->getAsPdf();
			$arResult=array(
				'result'=>200,
				'resultText'=>'ok',
