<?php 
/**
 * The EYiiPdf CApplicationComponent class.
...
class EYiiPdf extends CApplicationComponent {
	...
	protected function initLibrary($library_name, $constructorClassArgs = array(
		...
		$args = isset($this->params[$library_name]['defaultParams']) ? $constructorClassArgs + array_values($this->params[$library_name]['defaultParams']) : array(
		);
