 ...
 *
 *
 *                    Удалять или ОБНОВЛЯТЬ этот файл НЕЛЬЗЯ!!
 *                      (на самом деле можно, но осторожно)
 *
 *          Внесены изменения в AUTOCOPLETE для добавления плюсика к результатам поиска.
 *
 *
 *
 *
...
d.each(b,function(c,f){g._renderItem(a,f)})},_renderItem:function(a,b){return d("<li><img src='/images/plus.png' onClick='Package(0, "+b.id+")' title='Создать новый заказ'><img src='/images/list.png' onClick='loadData("+b.id+")' title='Список заказов этого клиента'></li>").data("item.autocomplete",b).append(d("<a></a>").text(b.label)).appendTo(a)},_move:function(a,b){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(a)||this.menu.last()&&/^next/.test(a)){this.element.val(this.term);this.menu.deactivate()}else this.menu[a](b);else this.search(null,b)},widget:function(){return this.menu.element}});d.extend(d.ui.autocomplete,{escapeRegex:function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,
